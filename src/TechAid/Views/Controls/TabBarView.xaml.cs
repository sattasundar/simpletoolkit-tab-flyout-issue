...
public partial class TabBarView : ContentView
{
    ...
    ContentButton floatingButton = null;
    TabBarIconView floatingIconView = null;
    ...
    public TabBarView()
    {
        ...
        currentIconView.TintColor = primaryColor as Color;

        floatingButton = buttonsGrid.ElementAt(2) as ContentButton;
        floatingIconView = floatingButton.Content as TabBarIconView;
    ...
    private void TabBarViewSizeChanged(object sender, EventArgs e)
    {
        ...
        SetCircleToX(GetCircleCenterX(floatingButton));
        floatingIconView.TranslationY = selectedIconTranslation;
    }
    ...
    private void ButtonTapped(object sender, EventArgs e)
    {
        ...
        App.Current.Resources.TryGetValue("Primary", out object primaryColor);
        var oldIconView = currentIconView;
        oldIconView.TintColor = Colors.Gray;
